  ...
  return(
    ...
    >
      <div className="w-full flex flex-row items-center justify-between mb-6">
        <span className="text-gray-600 text-2xl ml-2">Réglages</span>
      ...
      <div className="w-full flex flex-row items-center justify-between mb-2">
        <span className="text-gray-600 text-xl ml-2">Afficher les émoticônes</span>
        <span className="mr-2">
          <Toggle
      ...
      <div className="w-full flex flex-row items-center justify-between mb-2">
        <span className="text-gray-600 text-xl ml-2">Points de repère du visage</span>
        <span className="mr-2">
          <Toggle
